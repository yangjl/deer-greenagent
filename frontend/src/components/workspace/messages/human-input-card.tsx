    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1 space-y-3">
          ...
          {/* The wizard card omits the answered echo: its answer is every question
     and answer run together, which reads as a wall of text; the "Answered"
     badge already says what happened. */}
          {!allowText && !isForm && !setupQuestions && answeredResponse ? (
            <p className="text-muted-foreground text-sm" aria-live="polite">
              {t.humanInput.answeredValue(answeredResponse.value)}
            </p>
          ) : null}
