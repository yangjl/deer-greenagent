...
const MemoryScopeSettingsPage = dynamic(
  () =>
    import("./memory-scope-settings-page").then(
      (module) => module.MemoryScopeSettingsPage,
    ),
  { loading: SettingsPageLoading },
);
const DbtlReadinessSettingsPage = dynamic(
  () =>
    import("./dbtl-readiness-settings-page").then(
      (module) => module.DbtlReadinessSettingsPage,
    ),
  { loading: SettingsPageLoading },
);
