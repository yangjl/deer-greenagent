...
def upgrade() -> None:
    ...
    if "knowledge_claims" not in tables:
        raise RuntimeError("Migration 0017 requires the knowledge_claims table from the DBTL governance foundation; refusing to stamp an incomplete knowledge schema.")
