...
Revision ID: 0030_dbtl_conversational_discovery
...
revision = "0030_dbtl_conversational_discovery"
...
def downgrade() -> None:
    op.drop_index("ix_dbtl_discovery_outbox_pending", table_name="dbtl_discovery_outbox")
    op.drop_index("ix_dbtl_discovery_outbox_thread_id", table_name="dbtl_discovery_outbox")
    op.drop_index("ix_dbtl_discovery_outbox_project_id", table_name="dbtl_discovery_outbox")
    op.drop_index("ix_dbtl_discovery_outbox_discovery_id", table_name="dbtl_discovery_outbox")
    op.drop_table("dbtl_discovery_outbox")
    op.drop_index("uq_dbtl_discovery_active_thread", table_name="dbtl_discoveries")
    op.drop_index("ix_dbtl_discoveries_thread_id", table_name="dbtl_discoveries")
    op.drop_index("ix_dbtl_discoveries_project_id", table_name="dbtl_discoveries")
    op.drop_table("dbtl_discoveries")
